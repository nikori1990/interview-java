...
input.addEventListener('focus',init);input.addEventListener('keyup',search);function init(){input.removeEventListener('focus',init);loadScript('/interview-java/js/groupBy-62b30ac391.min.js');loadScript('/interview-java/js/flexsearch-ad47a5e1ee.min.js',function(){const indexCfg={};const dataUrl="/interview-java/en.search-data.min.json"
